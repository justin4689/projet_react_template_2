...
options = {
  ...
  colors: ["#0099ff", "#23c58f", "#f14e4e", "#eeb148"],
  legend: { offsetY: 5 },
};
(chart = new ApexCharts(
...
options = {
  ...
  colors: ["#23c58f", "#0099ff", "#f14e4e", "#5ba4e5", "#eeb148"],
  legend: {
    show: !0,
    position: "bottom",
