      ...
      <div className="page-content">
            ...
            <div className="row align-items-center">
              ...
              <div className="col-sm-6 text-sm-end mt-3 mt-sm-0">
                <Link to="/dashboard/user-create">
                  <button className="btn btn-warning me-2">Nouveau</button>
                </Link>
                <Link to="/dashboard">
                  <button className="btn btn-danger me-2">Lister</button>
                </Link>
        ...
        <div className="container-fluid">
              ...
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <p className="card-title-desc">
                    Exemple de formulaire en une colonne avec plusieurs types de
                    champs.
                  </p>
          ...
          <div className="now">
            <div className="card">
              <div className="card-body">
                <h4 className="header-title">Formulaire en deux colonnes</h4>
                <form>
                  {/* Ligne 1 : text + email */}
                  <div className="row">
                    <div className="col-md-6">
                      <div className="mb-3">
                        <label htmlFor="twoColFullName" className="form-label">
                          Nom complet (text)
                        </label>
                        <input
                          type="text"
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      <div className="mb-3">
                        <label htmlFor="twoColPassword" className="form-label">
                          Mot de passe (password)
                        </label>
                        <input
                          type="password"
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-6">
                      <div className="mb-3">
                        <label htmlFor="twoColBirthdate" className="form-label">
                          Date de naissance (date)
                        </label>
                        <input
                          type="date"
          ...
          <div className="now mt-4  ">
            <div className="card">
              <div className="card-body">
                <h4 className="header-title">Formulaire en trois colonnes</h4>
                <form>
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-4">
                      <div className="mb-3">
                        <label htmlFor="threeColAvatar" className="form-label">
                          Avatar (file)
                        </label>
                        <input
                          type="file"
